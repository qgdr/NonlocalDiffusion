...
\begin{equation}
    \begin{aligned}
        R_i =& \int_0^{x_1} +\int_{x_1}^{x_{\lceil \frac{i}{2}\rceil}} + ...               \\ 
...
\begin{equation}
    \begin{aligned}
        I_1 \le C x_1^{\alpha/2+1} x_i^{-1-\alpha} \le C h^{r\alpha/2 +r} x_i^{-1-\alpha}
    \end{aligned}
\end{equation}
...
\begin{equation}
    \begin{aligned}
        I_2 &\le C \int_{x_1}^{x_{\lceil \frac{i}{2}\rceil}} y^{\alpha/2-2} (h y^{(r-1)/r})^2 |x_i - y|^{-1-\alpha} dy      \\
