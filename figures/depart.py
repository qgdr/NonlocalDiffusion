...
class Depart(Scene):
    def construct(self):
        ...
        label2i_1 = MathTex(r"2i-1", color=RED).move_to(I_3_triangle_sk_2i_1).shift(DOWN*2).scale(0.5)
        ...
        label2i = MathTex(r"2i", color=GREEN_D).move_to(I_4_circle).shift(DOWN*2).scale(0.5)
        ...
        label2ip1 = MathTex(r"2i+1", color=BLUE_D).move_to(I_5_sqr_col).shift(DOWN*2).scale(0.5)
