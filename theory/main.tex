...
\begin{equation}
    \begin{aligned}
        ...
        +  \frac{1}{h_{i}} T_{i-1, j} \right)   \\
          ...
          & + \sum_{j=i+1}^{N-1} \frac{2}{h_i + h_{i+1}} 
          \left( \frac{1}{h_{i+1}} T_{i+1, j+1} 
          - (\frac{1}{h_{i}}+\frac{1}{h_{i+1}}) T_{i,j}
          +  \frac{1}{h_{i}} T_{i-1, j-1} \right)   \\
          & + \frac{2}{h_i + h_{i+1}} 
...
\begin{equation}
    \begin{aligned}
        ...
        & + \int_0^1 \frac{\theta (1-\theta)}{2} h_j^{4}  |x_i - y_j^\theta|^{1-\alpha} (\theta^2 u'''(\eta_{1,j}^\theta) -  (1-\theta)^2 u'''(\eta_{2,j}^\theta)) d\theta
    \end{aligned}
\end{equation}
...
\begin{equation}
    \begin{aligned}
        ...
        &\sim h^3 x^{1-3/r} + \frac{r-1}{r} h^3 (x^{1-4/r}z_R - x^{1-3/r})  \\
        &\sim h^3 (x^{1-3/r} + x^{1-4/r}z_R)    \\
        & < h^3 x^{1-3/r}
    \end{aligned}
\end{equation}
...
\begin{equation}
    \begin{aligned}
        |x-y_\theta|^{1-\alpha} &= |x-\theta y_L - (1-\theta) y_R |^{1-\alpha} \sim | (\theta z_L + (1-\theta) z_R) x^{1-1/r} |^{1-\alpha}  \\
...
\begin{equation}
    \begin{aligned}
        ...
        & \sim |x-y_\theta|^{-\alpha} x^{1/r-1} (\theta z_L + (1-\theta) z_R) x^{1-2/r} \\
        & \sim | (\theta z_L + (1-\theta) z_R) x^{1-1/r} |^{-\alpha} x^{-1/r} (\theta z_L + (1-\theta) z_R) \\
...
\begin{equation}
    \begin{aligned}
        ...
        \sim & | (\theta z_L + (1-\theta) z_R) x^{1-1/r} |^{-1-\alpha} x^{-2/r} (\theta z_L + (1-\theta) z_R)^2 \\
            &+ | (\theta z_L + (1-\theta) z_R) x^{1-1/r} |^{-\alpha} x^{-1-1/r} (\theta z_L + (1-\theta) z_R)   \\
        \sim & z_\theta^{1-\alpha} x^{-1-\alpha + (\alpha-1)/r}
    \end{aligned}
\end{equation}
...
\begin{equation}
    \begin{aligned}
        ...
        & \le C y_\theta^{\alpha/2-3} \sim x^{\alpha/2-3}
    \end{aligned}
\end{equation}
...
\begin{equation}
    \begin{aligned}
        ...
        \sim & x^{\alpha/2-4} + (\theta z_L + (1-\theta) z_R)x^{\alpha/2-3 -1-1/r}  \\
        < & x^{\alpha/2-4}
    \end{aligned}
\end{equation}
...
\begin{equation}
    \begin{aligned}
        ...
        = & K_2(x_i) u''''(\eta_{j}^\theta) (x_j-x_{j-2}) + K_2'(\xi)u'''(\eta_{1,j-1}^\theta)    \quad (\eta_j^\theta \in [x_{j-2}, x_{j}], \xi \in [x_{j-1}, x_{j}])\\
