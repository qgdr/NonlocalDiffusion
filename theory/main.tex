...
\begin{lemma}\label{lmm:AisM}
    % \begin{equation}
    %     \begin{aligned}
    %         S_i =\sum_{j=1}^{2N-1}a_{ij} = & \frac{-\kappa_\alpha}{(2-\alpha)(3-\alpha)} \frac{2}{h_i + h_{i+1}}                                               \\
...
\begin{proof}
    ...
    \begin{equation}
        \begin{aligned}
            ...
            % \ge \frac{2 \kappa_\alpha}{(2-\alpha)(3-\alpha)} (\frac{r}{2})^{1-\alpha} h^{1-\alpha}
        \end{aligned}
    \end{equation}
    ...
    \begin{equation}
        \begin{aligned}
            ...
            % & \ge 4 \kappa_\alpha r^{1-\alpha} h^{1-\alpha} 
        \end{aligned}
    \end{equation}
