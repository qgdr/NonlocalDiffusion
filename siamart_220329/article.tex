...
\begin{proof}
  ...
  \begin{equation}
    \begin{aligned}
      \sum_{j=N+1}^{2N-1} S_{ij} &\le C T^{-1-\alpha} h^2 \int_{x_{N}}^{x_{2N-1}} (2T-y)^{\alpha/2-2/r}  dy \\
...
\begin{lemma} \label{lmm:R1R2}
  By \cref{lmm:sumSij13} , \cref{lmm:sumSi-ilessNdiv2-2ip1-N}  and \cref{lmm:sumSi-ilessNdiv2-Np1-2N}   we get
  \begin{equation}
    \begin{aligned}
      R_1 &= \sum_{j=1}^{3} S_{1j} + \sum_{j=4}^{2N} S_{1j}  \\
      &\le C h^2 x_1^{-\alpha/2-2/r} + \begin{cases}
        C h^2, & \alpha/2-2/r+1 > 0 \\
        C h^2 \ln(N) , & \alpha/2-2/r+1 = 0  \\
        C h^{r\alpha/2+r}, & \alpha/2-2/r+1 < 0
      \end{cases}
  ...
  \begin{equation}
    \begin{aligned}
      ...
      &\le C h^2 x_2^{-\alpha/2-2/r} + \begin{cases}
        C h^2, & \alpha/2-2/r+1 > 0 \\
        C h^2 \ln(N) , & \alpha/2-2/r+1 = 0  \\
        C h^{r\alpha/2+r}, & \alpha/2-2/r+1 < 0
      \end{cases}
...
\begin{theorem} \label{Ri-idiv22i-I3}
  There exists a constant \(C=C(T, \alpha, r, \|u\|_{\beta+\alpha}^{(-\alpha/2)})\) such that for \(3\le i < N/2, k=\lceil\frac{i}{2}\rceil\),
  \begin{equation}
    I_3 = \sum_{j=k+1}^{2i-1} V_{ij} \le C h^2 x_i^{-\alpha/2-2/r} := Sorry
  \end{equation}
\end{theorem}
}
...
\begin{lemma} \label{lmm:Vijleh2xma22r}
  There exists a constant \(C=C(T, \alpha, r, f)\) such that for \(3\le i < N, k=\lceil\frac{i}{2}\rceil, k+1 \le j \le \min\{2i-1, N-1\}\),
  \begin{equation}
...
\begin{lemma} \label{lmm:dhj-i3le-Ch2xi1-2r}
  ...
  \end{equation}
  \begin{equation}
    (h_{j-i}^4(\xi))' \le (r-1) C h^3 x_{i}^{2-3/r} h_{j}
  \end{equation}
\end{lemma}
}
\begin{proof}
  ...
  \begin{equation}
    ...
    \end{aligned}
  \end{equation}
  For \(\xi\in [x_{i-1}, x_{i+1}]\) and \(3\le \lceil\frac{i}{2}\rceil+1 \le j \le \min\{2i-1, N-1\}\), using \cref{lmm:hilexi}
  \begin{equation*}
    \begin{aligned}
  ...
  \end{equation}
  So we can get
  \begin{equation} \label{eq:yj1-1divr-yj-1}
  ...
  \begin{equation}
    \begin{aligned}
      (h_{j-i}^l(\xi))' &\le l(r-1)C \; h_j  h_{j+1}^{l-2}  h  x_i^{-1/r}  \\
      &\le l (r-1)C h h_j ( h x_{i}^{1-1/r})^{l-2}  x_i^{-1/r}    \\
      &= (r-1)C \; h^{l-1}   x_i^{l-2-(l-1)/r} h_j
    \end{aligned}
  \end{equation}
  Meanwhile, we can get 
  \begin{equation} \label{eq:hj-i3leCh2x2-2rhj}
