...
\begin{proof}
  ...
  \begin{equation}
    \begin{aligned}
      ...
      & = -\kappa_\alpha D_h^2 (p(x_i) + q(x_i))
    \end{aligned}
  \end{equation}
  for \(1\le i<N-1\),by \cref{lmm:Dh2simd2}
  \begin{equation}
    \begin{aligned}
      D_h^2 p(x_i) & := -\kappa_\alpha\frac{2}{h_i + h_{i+1}}
  ...
  \begin{equation}
    \begin{aligned}
      D_h^2 p(x_{N-1}) & := \frac{-2\kappa_\alpha}{h_{N-1} + h_{N}}
  ...
  \begin{equation}
    \begin{aligned}
      D_h^2(x_N) & := -\kappa_\alpha \frac{2}{h_N + h_{N+1}}
