...
\begin{proof}
  ...
  \begin{lemma}
    \begin{gather}
      ...
      (h_{i\to N}^3(\xi))'' \le C (r-1) h_N^2 \le C (r-1) h^2 
    \end{gather}
  \end{lemma}
  \begin{proof}
    \begin{equation}
    ...
    \begin{equation}
      \begin{aligned}
        (h_{i\to N}^3(\xi))'' &= 6 h_{i\to N}(\xi) ({y_{i\to N}}'(\xi) - {y_{i\to N-1}}'(\xi))^2  \\
        &\quad + 3 h_{i\to N}^2(\xi) ({y_{i\to N}}''(\xi) - {y_{i\to N-1}}''(\xi) )       \\
        &\le C (r-1)^2 h_N x_i^{2/r-2} h^2 + C h_N^2 \frac{r-1}{r} x_i^{1/r-2} (\frac{h_N}{rZ_1}- y_{i\to N-1}^{1-2/r}(\xi)Z_{N-1-i}  ) \\
      \end{aligned}
    \end{equation}
    \begin{equation*}
      \begin{aligned}
    ...
    \begin{equation}
      \begin{aligned}
        (h_{i\to N}^3(\xi))'' 
        &\le C (r-1)^2 h_N x_i^{2/r-2} h^2 + C h_N^2 \frac{1-r}{r} x_i^{1/r-2}  \\
  ...
  \begin{proof}
    \begin{equation}
      \begin{aligned}
        (y_{i\to N}^\theta(\xi) - \xi)' &= (\theta (y_{i\to N-1}(\xi) - \xi) + (1-\theta) (y_{i\to N}(\xi) - \xi))' \\
    ...
    \begin{equation}
      \begin{aligned}
        (y_{i\to N}^\theta(\xi) - \xi)'' &= \theta ({y_{i\to N-1}}''(\xi)) + (1-\theta) ( {y_{i\to N}}''(\xi) ) \\
