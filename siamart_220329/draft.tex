...
\end{proof}
  ...
  \begin{proof}
    Since \cref{lmm:Vij-int}, by \(x_i \simeq x_j\), \cref{lmm:hilexi}, \cref{lmm:d2Pj-itle}, \cref{lmm:dQj-itle}, we get the result immediately.
  \end{proof}
...
\begin{lemma}
  ...
  \begin{equation}
    \begin{aligned}
      S_{ij} \le & C h^2 \int_{x_{j-1}}^{x_{j}} \Big(  |y-x_i|^{1-\alpha} + (r-1) |y-x_i|^{-\alpha}  \Big) dy
    \end{aligned}
  \end{equation}
\end{lemma}
...
\begin{proof}
  \begin{equation}
    \begin{aligned}
      ...
      \Big(|y-x_i|^{1-\alpha} + (r-1) |y-x_i|^{-\alpha}\Big) dy    \\
    \end{aligned}
  \end{equation}
  ...
  \begin{equation}
    \begin{aligned}
      I_3^3 & \le C h^2 \int_{x_{N+1}}^{x_{2N-\lceil\frac{N}{2}\rceil}} |y-x_i|^{1-\alpha} + (r-1)|y-x_i|^{-\alpha}    \\
          ...
          & = C h^2 + C(r-1) h^2 |T-\delta(x_{i}) + h_N|^{1-\alpha}
    \end{aligned}
  \end{equation}
