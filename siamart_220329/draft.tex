...
\begin{remark}[Weaker regularity on the derivatives of \(u\) and \(f\)]
  Suppose that the bound of \cref{thm:regularity-u} and \cref{thm:regularity-f}
